...
def main():
    ...
    win_counts = [0, 0, 0]  # [player1 win, player2 win, ties]
    exit = False
    while not exit:
...
def printStats(player1, player2, win_counts):
    print('{}: {} win(s), {}: {} win(s), {} tie(s)'.format(player1.name,
